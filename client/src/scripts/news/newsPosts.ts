...
export const news: NewsPost[] = [
    {
        ...
        content: `
        - Teleport (Team ping arrow) <b>3s</b> CD
        <br />
        - Toggle Infinite Ammo (Thumbs up emote)
        <br />
        - Spawn Airdrop (Sad face) <b>3s</b> CD (shared)
        <br />
        - Spawn loot (Team ping gift) <b>3s</b> CD (shared)
        <br />
        - Instant heal (Happy face emote) <b>40s</b> CD
        <br />
        - Spawn Random Obstacle (Team ping heal) <b>5s</b> CD
        <br />
        - Teleport everyone to current location (Suroi logo, admin only)
        <br />
        - Trigger explosion (Warning ping)
        <br />
        TELEPORTATION REVEALS YOUR LOCATION FOR 3 SECONDS
        `,
        longContent: `
        <h3>New Features:</h3>
        <ul>
            <li>Teleport (Team ping arrow)</li>
            <li>Toggle Infinite Ammo (Thumbs up emote)</li>
            <li>Spawn Airdrop (Team ping heal)</li>
            <li>Spawn loot (Team ping gift)</li>
            <li>Instant heal (Happy face emote, admin only)</li>
            <li>Teleport everyone to current location (Suroi logo, admin only)</li>
            <li>Trigger explosion (Team ping warning, admin only)</li>
        </ul>
        `
    },
    {
